...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        with(savedInstanceState) {
            isTimerActive = getBoolean("isTimerActive")
            currentProgress = getInt("currentProgress",currentProgress)
            slider.isEnabled = getBoolean("sliderEnabled")
            slider.value = getFloat("sliderValue")
            progressBar.progress = getInt("progressBarProgress")
            progressText.text = getCharSequence("progressText")
            button.text = getCharSequence("button")
        }
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        outState.run {
            putInt("currentProgress", currentProgress)
            putBoolean("isTimerActive", isTimerActive)
            putBoolean("sliderEnabled", slider.isEnabled)
            putFloat("sliderValue", slider.value)
            putInt("progressBarProgress", progressBar.progress)
